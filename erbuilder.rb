class Erbuilder < Formula
  ...
  url "https://github.com/eujoy/erbuilder/releases/download/v0.3.3/erbuilder-v0.3.3-darwin-amd64.tar.gz"
  version "v0.3.3"
  sha256 "5cc5e2b1c7f03e8759206e1dd36abe90bc4ef912f43d9e140ec5d26115c44888"

  if OS.linux?
    url "https://github.com/eujoy/erbuilder/releases/download/v0.3.3/erbuilder-v0.3.3-linux-amd64.tar.gz"
